...
class LicencaGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Licenca entity")
        ...
        .repeat(2) {
            ...
            .post("/api/licencas")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "status":null, "licenNumero":"SAMPLE_TEXT", "licenCondicoesValidade":"SAMPLE_TEXT", "licenValidade":"0", "licenCaracteristica":"SAMPLE_TEXT", "licenDataEmissao":"2020-01-01T00:00:00.000Z", "licenDataEntrega":"2020-01-01T00:00:00.000Z", "tipo":null}""")).asJSON
            .check(status.is(201))
